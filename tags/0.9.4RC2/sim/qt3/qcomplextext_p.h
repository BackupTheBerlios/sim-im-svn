/****************************************************************************
** $Id: qcomplextext_p.h,v 1.6 2004/06/26 08:17:05 shutoff Exp $
**
...
struct QBidiContext : public QShared {
...
public:
    ...
    static QString shapedString( const QString &str, int from = 0, int len = -1, const QFontMetrics *fm = 0);
