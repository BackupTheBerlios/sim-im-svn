/****************************************************************************
** $Id: qkeysequence.cpp,v 1.10 2004/06/26 08:17:06 shutoff Exp $
**
...
/*!
  ...
  "QAccel" scope (using QObject::i18n()).

  This contructor is typically used with \link QObject::i18n() tr
  \endlink(), so that accelerator keys can be replaced in
  translations:

  \code
    QPopupMenu *file = new QPopupMenu( this );
    file->insertItem( i18n("&Open..."), this, SLOT(open()),
		      QKeySequence( i18n("Ctrl+O", "File|Open") ) );
  \endcode
...
/*!
   ...
   "Shift", etc. are translated (using QObject::i18n()) in the "QAccel"
   scope.
*/
